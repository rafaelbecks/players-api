...
class UsuarioXSeguidoresController
{
    ...
    public function getAll()
    {
        ...
        try {
            ...
            $phql = 'SELECT * FROM UsuarioXSeguidores'.$filtros;
            ...
            if(count($resul)>0){
                ...
                foreach ($resul as $res) {
                    $data[] = [
                        'id'   => $res->id,
                        'id_seguidor' => Usuarios::find($res->id_seguidor),
    ...
    {
        try {
            $phql = 'SELECT * FROM UsuarioXSeguidores WHERE id = '.$id;
    ...
    {
        try {
            $phql = 'DELETE FROM UsuarioXSeguidores WHERE id = '.$id;
   ...
   public function registrar() {
    ...
    public function update($id = null) {
        try {
            ...
            $data = $this->app->request->getJsonRawBody();
            $resul = UsuarioXSeguidores::find($id);
            if(count($resul)>0){
                $data = (array)$data;
    ...
    public static function getInstance($app)
    {
        if(is_null(static::$instance)){
            static::$instance = new UsuarioXSeguidoresController($app);
        }
