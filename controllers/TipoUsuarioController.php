...
class TipoUsuarioController
{
    ...
    public function getAll()
    {
        ...
        try {
            ...
            $phql = 'SELECT * FROM TipoUsuario'.$filtros;
    ...
    {
        try {
            $phql = 'SELECT * FROM TipoUsuario WHERE id = '.$id;
    ...
    {
        try {
            $phql = 'DELETE FROM TipoUsuario WHERE id = '.$id;
   ...
   public function registrar() {
    ...
    public static function getInstance($app)
    {
        if(is_null(static::$instance)){
            static::$instance = new TipoUsuarioController($app);
        }
